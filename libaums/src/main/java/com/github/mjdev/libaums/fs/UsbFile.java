...
public interface UsbFile extends Closeable {
	...
	/**
	 * Returns the timestamp this directory or file was created.
	 */
	long createdAt();
	
	/**
	 * Returns the timestamp this directory or file was last modified.
	 */
	long lastModified();
	
	/**
	 * Returns the timestamp this directory or file was last accessed.
	 */
	long lastAccessed();
	...
	String[] list(UsbDeviceConnection deviceConnection) throws IOException;
	...
	UsbFile[] listFiles(UsbDeviceConnection deviceConnection) throws IOException;

	/**
	 * Get the file length in bytes or throws an exception if called on a directory.
	 */
	long getLength();

	/**
	 * Sets the new file length in bytes.
	 */
	...
	void read(UsbDeviceConnection deviceConnection, long offset, ByteBuffer destination) throws IOException;
	...
	void write(UsbDeviceConnection deviceConnection, long offset, ByteBuffer source) throws IOException;
	 ...
	 * @throws IOException If writing to the disk fails or a item with the same name already exists.
	 */
	...
	void moveTo(UsbDeviceConnection deviceConnection, UsbFile destination) throws IOException;
	...
	/**
	 * Return if the current directory is the root directory
	 */
	boolean isRoot();
}
