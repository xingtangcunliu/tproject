...
public class UsbFileInputStream extends InputStream {
    ...
    public UsbFileInputStream(UsbDeviceConnection deviceConnection, UsbFile file) {
    ...
    public int read() throws IOException {
        ...
        if(deviceConnection != null) {
            file.read(deviceConnection, currentByteOffset, buffer);
        } else {
    ...
    public int read(byte[] buffer) throws IOException {
        ...
        if(deviceConnection != null) {
            file.read(deviceConnection, currentByteOffset, byteBuffer);
        } else {
