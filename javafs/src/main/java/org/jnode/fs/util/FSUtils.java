...
public class FSUtils {
    ...
    public static String toString(FSEntry entry, boolean deep) {
        ...
        if (deep && entry.isDirectory())
            try {
                ...
                log.error("e in getDirectory", e3);
            }
        sb.append("</FSEntry>");
     ...
     * @throws IllegalArgumentException if the value is too large to convert to an integer.
     */
