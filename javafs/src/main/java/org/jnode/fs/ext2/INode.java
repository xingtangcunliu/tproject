...
public class INode {
    ...
    private final void registerBlockIndex(long i, long blockNr)
        ...
        if (i < indirectCount) {
            ...
            if (i == 0) {
                ...
                //log.d("reserved indirect block: "+indirectBlockNr);
        ...
        if (i < doubleIndirectCount) {
            ...
            if (i == 0) {
                ...
                //log.d("reserved double indirect block:
        ...
        if (i < tripleIndirectCount) {
            ...
            if (i == 0) {
                ...
                //log.d("reserved triple indirect block:
    ...
    public synchronized int getMode() {
        ...
        //log.d("INode.getIMode(): "+Ext2Print.hexFormat(iMode));
        return iMode;
    }
