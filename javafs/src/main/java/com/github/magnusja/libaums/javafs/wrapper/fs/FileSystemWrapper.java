...
public class FileSystemWrapper implements FileSystem {
    ...
    public UsbFile getRootDirectory() {
        try {
            ...
            Log.e(TAG, "e getting root entry", e);
            return null;
        }
    }
    ...
    public String getVolumeLabel() {
        try {
            ...
            Log.e(TAG, "e getting volume label", e);
            return "";
        }
    }
    ...
    public long getCapacity() {
        try {
            ...
            Log.e(TAG, "e getting capacity", e);
            return 0;
        }
    }
    ...
    public long getOccupiedSpace() {
        try {
            ...
            Log.e(TAG, "e getting total - free space", e);
            return 0;
        }
    }
    ...
    public long getFreeSpace() {
        try {
            ...
            Log.e(TAG, "e getting free space", e);
            return 0;
        }
    }
    ...
    public int getChunkSize() {
        try {
            ...
            Log.e(TAG, "e getting sector size", e);
            return 4096;
